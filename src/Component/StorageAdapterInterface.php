...
interface StorageAdapterInterface
{
     ...
     *
     * @param int|string $id The unique ID of the record.
     *
     ...
     *
     * @param array $ids An array The unique IDs of the records to fetch.
     *
     ...
     *
     * @param array $ids An array The unique IDs of the records.
     *
     ...
     */
    public function hasRecords(array $ids);
     ...
     *
     * @param array $ids The unique ID of the record.
     *
     * @return bool True if a record with the given ID exists and was deleted, false otherwise.
     */
